...
### x86_64
```
bash <(curl -Ls https://cdn.jsdelivr.net/gh/SplendorAnLin/XrayR-V2Board/install.sh)
```
### ARM_64
```
bash <(curl -Ls https://cdn.jsdelivr.net/gh/SplendorAnLin/XrayR-V2Board/install-arm.sh)
```
